   ...
   <body>
    ...
    <div class="logo-details">
      <img src="img/star.png" class="icon">
        <div class="logo_name">HouseNow</div>
    </div>
    <ul class="nav-list">
        ...
        <div class="container">
            ...
            <div class="feedback-box">
                ...
                <ul class="feedback-list">
                  <li><img src="img/doctor2.jpg" style="width: 35px;height: 35px;border-radius: 25px;margin-right: 2%;float: left;margin-top: 3%;"><span class="feedback-text"><span class="user">Mohamed Zahar :</span> <span class="feedback">This app is so easy to use, i would love it if we had the chance to do online consultations </span></span><div class="clearfix"></div></li>
                  <li><img src="img/doctor2.jpg" style="width: 35px;height: 35px;border-radius: 25px;margin-right: 2%;float: left;margin-top: 3%;"><span class="feedback-text"><span class="user">Mohamed Zahar :</span> <span class="feedback">This app is so easy to use, i would love it if we had the chance to do online consultations </span></span><div class="clearfix"></div></li>
                  <li><img src="img/doctor2.jpg" style="width: 35px;height: 35px;border-radius: 25px;margin-right: 2%;float: left;margin-top: 3%;"><span class="feedback-text"><span class="user">Mohamed Zahar :</span> <span class="feedback">This app is so easy to use, i would love it if we had the chance to do online consultations </span></span><div class="clearfix"></div></li>
                  <li><img src="img/doctor2.jpg" style="width: 35px;height: 35px;border-radius: 25px;margin-right: 2%;float: left;margin-top: 3%;"><span class="feedback-text"><span class="user">Mohamed Zahar :</span> <span class="feedback">This app is so easy to use, i would love it if we had the chance to do online consultations </span></span><div class="clearfix"></div></li>
                  <li><img src="img/doctor2.jpg" style="width: 35px;height: 35px;border-radius: 25px;margin-right: 2%;float: left;margin-top: 3%;"><span class="feedback-text"><span class="user">Mohamed Zahar :</span> <span class="feedback">This app is so easy to use, i would love it if we had the chance to do online consultations </span></span><div class="clearfix"></div></li>
