...
<html lang="en" dir="ltr">
  <head>
    <meta charset="UTF-8">
    <meta name="description" content="e-Doc">
    <meta name="keywords" content="digital doctor,rendez-vous,consultation">
  ...
  <div class="dashboard">
      ...
      <section class="themes">
          <a href="#" class="box-color green">
            Green
          </a>
          <a href="#" class="box-color red">
            Red
          </a>
          <a href="#" class="box-color yellow">
            Yellow
          </a>
          <a href="#" class="box-color blue">
            Blue
          </a>
          <a href="#" class="box-color white">
            White
          </a>
          <div class="clearfix"></div>
      </section> 
